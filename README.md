...
Instalar dependencias e validar build.
Conectar Drizzle ao PostgreSQL.
Implementar CRUD real de quizzes.
Criar fluxo de publicacao.
Conectar lobby ao servidor Socket.io.
Persistir sessoes e participantes.
